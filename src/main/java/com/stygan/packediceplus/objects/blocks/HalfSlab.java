...
public class HalfSlab extends Block implements IWaterLoggable {
   ...
   protected static final VoxelShape NWD_CORNER = Block.makeCuboidShape(0.0D, 16.0D, 0.0D, 8.0D, 8.0D, 8.0D);
   protected static final VoxelShape SWD_CORNER = Block.makeCuboidShape(0.0D, 16.0D, 8.0D, 8.0D, 8.0D, 16.0D);
   ...
   protected static final VoxelShape NED_CORNER = Block.makeCuboidShape(8.0D, 16.0D, 0.0D, 16.0D, 8.0D, 8.0D);
   protected static final VoxelShape SED_CORNER = Block.makeCuboidShape(8.0D, 16.0D, 8.0D, 16.0D, 8.0D, 16.0D);
   ...
   @Deprecated
   protected HalfSlab(BlockState state, Block.Properties properties) {
      super(properties);
   ...
   public HalfSlab(java.util.function.Supplier<BlockState> state, Block.Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
...
public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof HalfSlab;
   }
